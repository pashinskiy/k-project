...
const useStyle = makeStyles(theme => ({
  ...
  buttonPrevWrapper: {
    ...
    background: props =>
      props.maxTranslateX < 0 && props.buttonNext
        ? `linear-gradient(90deg, #EFEFF2 9.1%, rgba(239, 239, 242, 0) 100%)`
        : "none",
  ...
  buttonNextWrapper: {
    ...
    background: props =>
      props.maxTranslateX < 0 && props.buttonNext
        ? `linear-gradient(270deg, #EFEFF2 9.1%, rgba(239, 239, 242, 0) 100%)`
        : "none",
...
/**
 * Слайдер популярных ремонтов
 * @module src/components/repairPage/popularRepair/scrollBar
