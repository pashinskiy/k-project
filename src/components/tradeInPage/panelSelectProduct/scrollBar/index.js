 ...
 * @module src/components/tradeInPage/panelSelectProduct/scrollBar
...
export default function ScrollBar({ children }) {
  ...
  const classes = useStyle({ maxTranslateX })
  ...
  return (
    <Grid container className={classes.wrapper}>
      ...
      {maxTranslateX < 0 && showPrev && !mobile ? (
      ...
      {maxTranslateX < 0 && showNext && !mobile ? (
